...
def build_vm_skills() -> list[Skill]:
    """构造 10 个纯 content 型 Skill 对象，注册给 SkillsProvider.
    ...
    return [
        ...
        _content_skill_from_md("vm-hostname-lookup"),  # 主机名 ⇄ 实例 ID 互查：用法一经 Resource Graph(az rest POST)按 instanceView.computerName 反查实例，用法二经 get-instance-view 查主机名
